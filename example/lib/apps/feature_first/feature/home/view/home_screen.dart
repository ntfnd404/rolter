import '../../animated/routing/animated_nav.dart';
import '../../confirm/routing/confirm_nav.dart';
import '../../detail/routing/detail_nav.dart';
import '../../editor/routing/editor_nav.dart';
import 'widgets/home_tile.dart';
import '../../mailbox/routing/mailbox_nav.dart';
import '../../sub_routers/shell/routing/demo_module.dart';
import '../../sub_routers/shell/routing/modules_nav.dart';
import '../../independent_tab_stacks/shell/routing/multitabs_nav.dart';
import '../../picker/routing/picker_nav.dart';
import '../../route_scope/routing/scope_nav.dart';
import '../../session/bloc/lock_bloc.dart';
import '../../session/bloc/lock_event.dart';
import '../../tabbed_stack/shell/routing/tabs_nav.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          DemoHomeContent(
            approach: 'Feature-owned definitions with constructor injection',
            onOpenItems: nav.toTabs,
          ),
