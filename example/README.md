...
| Guard history/context | `NavigationLogGuard` | Reads `history`, classifies push/pop/replace, shares it via `context` |
...
lib/
  ...
  routing/             shared routing core
    ...
    nav_log_guard.dart   cross-cutting guard (history / context)
  ...
  feature/             one self-contained folder per feature, in light
    ...
    home/ mailbox/ items/ overlays/ session/ scope/
```
